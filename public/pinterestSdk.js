...
window.PDK ||
  (function (window) {
    ...
    function create(a, b) {
      for (
        var c = window.PDK, d = a ? a.split(".") : [], e = d.length, f = 0;
        e > f;
        f++
      ) {
        var g = d[f],
    ...
    include(PDK, {
      ...
      request: function () {
        ...
        for (
          "/" === e[0] && (e = e.substr(1)),
            -1 === e.indexOf(Api.__PREFIX) && (e = Api.__PREFIX + e),
            -1 === e.indexOf("/", e.length - 1) && (e += "/");
          f;
        ...
        return (
          (a = a || "get"),
          (b = b || {}),
          Api.__SUPPORTED_METHODS.indexOf(a) < 0
            ? void log("Invalid method passed to api:" + a)
            : void Api.oauthRequest(e, a, b, c)
        );
      },
    });
    var Api = {
      ...
      triggerRequest: function (a, b, c, d, e, f) {
        ...
        window.XMLHttpRequest
          ? a.open(b, g, !0)
          : window.XDomainRequest && a.open(b, g),
        ...
        j && (k += (a.indexOf("?") > -1 ? "&" : "?") + j),
          window.XMLHttpRequest
                ...
                (h.onreadystatechange = function () {
                  4 === h.readyState &&
                    (h.status >= 200 && h.status < 400
                      ...
                      : ((i = h.status),
                        Api.invokeXHRCallback(h, b, k, c, e, f, i)));
                }),
                Api.triggerRequest(h, b, k, e, c)))
            ...
            ? ((h = new window.XDomainRequest()),
              ...
              Api.triggerRequest(h, b, k, e, c))
            : g(new Error("CORS not supported"));
      },
      ...
      oauthRequest: function (a, b, c, d) {
        ...
        if (
          (c.accessToken
            ? ((e = c.accessToken), delete c.accessToken)
            : (e = Auth.getAccessToken()),
          !e)
        )
          return void log(
            "A request was made on behalf of a user before they were authenticated."
          );
        var f = null;
        ...
        try {
          Api.executeCorsRequest(a, b, e, c, f, d, function (a) {
            var b =
              "The request did not complete because of a failure on the network level.";
    ...
    include(PDK, {
      login: function (a, b) {
        ...
        if (a.scope) {
          ...
          d &&
            !Auth.isNewPermRequested(a.scope, d) &&
            (c = "The current user is already authenticated");
        } else c = "Cannot login without providing scope as an option";
        return c
          ? void b({ error: c })
          : ((a = copy({ method: "auth.login" }, a || {})),
            void UI.createCall(a, b));
      },
      logout: function (a) {
    ...
    var Auth = {
      ...
      setSession: function (a) {
        var b = !_session && a,
          c = _session && !a,
          d =
            b || c || (_session && a && _session.accessToken !== a.accessToken),
          e = { session: a };
    ...
    include(PDK, {
      init: function (a) {
        (a = copy(a || {}, { logging: !0 })),
          ...
          _appId &&
            (Cookie.setEnabled(a.cookie),
            (a.session = a.session || Cookie.load()),
            Auth.setSession(a.session));
      },
    }),
        ...
        for (var b in UI._active)
          if (UI._active.hasOwnProperty(b) && b in UI._defaultCb) {
            ...
            try {
              var e = d.location;
              d.closed
                ? ((a = !1), UI.triggerEvent(b))
                : c.useRedirect &&
                  UI.isRedirectedToSameOrigin(e, c.redirect_uri_origin) &&
                  ((c.redirected_uri = e.href), d.close());
            } catch (f) {
              log(f);
            }
          }
        a && !UI.popupInterval[b]
          ? (UI.popupInterval[b] = window.setInterval(UI.monitorPopup, 100))
          : !a &&
            UI.popupInterval[b] &&
            (window.clearInterval(UI.popupInterval[b]),
            (UI.popupInterval[b] = null));
      },
    ...
    var Cookie = {
        ...
        load: function () {
          ...
          return (
            b && ((a = QS.decode(b[1])), (Cookie._domain = a.base_domain)), a
          );
        },
        setRaw: function (a, b, c) {
          (document.cookie =
            ...
            (a && 0 === b
              ? ""
              : "; expires=" + new Date(1e3 * b).toGMTString()) +
            "; path=/" +
            (c ? "; domain=." + c : "")),
            (Cookie._domain = c);
        },
      ...
      QS = {
        ...
        decode: function (a) {
          for (
            var b, c = decodeURIComponent, d = {}, e = a.split("&"), f = 0;
            f < e.length;
            f++
          )
